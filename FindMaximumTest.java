...
public class FindMaximumTest {
     ...
     */
    @Test
    public void ifIntegerNumberOneIsMaxReturnTrue() {
    ...
    @Test
    public void ifIntegerNumberTwoIsMaxReturnTrue() {
        TestMaximum<Integer> testMaximumInteger = new TestMaximum<>(50, 100, 25);
        Assertions.assertEquals(100, testMaximumInteger.testMaximum());
    }

    @Test
    public void ifIntegerNumberThreeIsMaxReturnTrue() {
    ...
    @Test
    public void ifStringOneIsMaxReturnTrue() {
